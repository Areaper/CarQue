...
- (void)viewWillAppear:(BOOL)animated{
    [DownLoad downLoadWithUrl:KCQFindCarAPI resultBlock:^(NSData *data) {
        NSDictionary *dictory = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingMutableContainers error:nil];
        NSArray *arr = dictory[@"result"];
        for (NSDictionary *dic in arr) {
            CQFindCarLogoListModel *LogoModel = [[CQFindCarLogoListModel alloc]init];
            [LogoModel setValuesForKeysWithDictionary:dic];
