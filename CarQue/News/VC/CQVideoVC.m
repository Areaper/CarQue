...
@interface CQVideoVC ()<UIScrollViewDelegate,UITableViewDataSource,UITableViewDelegate>
...
- (void)setPictureTabview
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"CQPictureViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"video"];
...
- (void)dealWithData
{
    NSURL *url = [NSURL URLWithString:KCQVideotAPI]; // 根据 API 获取
...
{
    CQPictureViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"video" forIndexPath:indexPath];
